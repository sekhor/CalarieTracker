...
import {
  ...
  ChevronRight, Utensils, Settings2
} from 'lucide-react';
...
export default function DashboardView({ stats, isLoading = false, error = '', onRetry, onNavigate, onOpenAddModal }) {
      ...
      <div className="glass-panel hero-banner">
        ...
        <div className="hero-banner-inner">
          ...
          <div className="hero-actions">
            <button onClick={() => onNavigate('profile')} className="btn btn-secondary" title="Manage physical profile & daily goals">
              <Settings2 size={16} /> Profile & Goals
            </button>
